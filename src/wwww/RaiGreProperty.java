 ...
 * @PackageName:wwww
 * @ClassName: RaiGreProperty
 * @Description: TODO
 * @Version 1.0
 */
public class RaiGreProperty extends Property{
    int value;
    String color = "railroadandgreen";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public RaiGreProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public RaiGreProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/railraod-and-green-wildcard-card.png"));
