...
public class YellowProperty extends Property{
    ...
    public YellowProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public YellowProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/yellowproperty.png"));
