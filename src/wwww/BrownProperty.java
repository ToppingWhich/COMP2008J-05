...
public class BrownProperty extends Property {
    ...
    public BrownProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public BrownProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/brownproperty.png"));
