...
public class LightBlueProperty extends Property{
    ...
    public LightBlueProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public LightBlueProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/lightblueproperty.png"));
