...
public class OrangeProperty extends Property{
    ...
    public OrangeProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public OrangeProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/orangeproperty.png"));
