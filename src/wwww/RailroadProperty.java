 ...
 * @PackageName:wwww
 * @ClassName: RailroadProperty
 * @Description: TODO
 * @Version 1.0
 */
public class RailroadProperty extends Property {
    int value;
    String color = "railroad";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public RailroadProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public RailroadProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/railroadproperty.png"));
