 ...
 * @PackageName:wwww
 * @ClassName: RaiUtiProperty
 * @Description: TODO
 * @Version 1.0
 */
public class RaiUtiProperty extends Property {
    int value;
    String color = "railroadandutility";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public RaiUtiProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public RaiUtiProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/railroad-and-utility-wildcard-card.png"));
