 ...
 * @PackageName:wwww
 * @ClassName: LigRaiProperty
 * @Description: TODO
 * @Version 1.0
 */
public class LigRaiProperty extends Property{
    int value;
    String color = "lightblueandrailroad";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public LigRaiProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public LigRaiProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/railraod-and-light-blue-wildcard-card.png"));
