 ...
 * @PackageName:wwww
 * @ClassName: PurOraProperty
 * @Description: TODO
 * @Version 1.0
 */
public class PurOraProperty extends Property{
    int value;
    String color = "purplrandorange";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public PurOraProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public PurOraProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/orange-and-pink-wildcard-card.png"));
