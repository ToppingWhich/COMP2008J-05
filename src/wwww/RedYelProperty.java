 ...
 * @PackageName:wwww
 * @ClassName: RedYelProperty
 * @Description: TODO
 * @Version 1.0
 */
public class RedYelProperty extends Property {
    int value;
    String color = "redandyellow";
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public RedYelProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public RedYelProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/red-and-yellow-wildcard-card.png"));
