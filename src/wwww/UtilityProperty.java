...
public class UtilityProperty extends Property{
    ...
    public UtilityProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public UtilityProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/utilityproperty.png"));
