 ...
 * @PackageName:wwww
 * @ClassName: GreBluProperty
 * @Description: TODO
 * @Version 1.0
 */
public class GreBluProperty extends Property{
    int value;
    public static ArrayList<ColorEnum> colorArray;
    public  static String cardType ="Property";

    GameScreen gameScreen;
    public GreBluProperty(GameScreen gameScreen, String name, boolean up) {
        ...
        //Add mouse monitoring for each card
        this.addMouseListener(this);
    }
    public GreBluProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/dark-blue-and-green-wildcard-card.png"));
