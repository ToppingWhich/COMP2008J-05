...
public class GreenProperty extends Property{
    ...
    public GreenProperty(GameScreen gameScreen, String name, boolean up) {
    ...
    public GreenProperty(GameScreen gameScreen, String name, boolean canClick, boolean clicked) {
        this.gameScreen = gameScreen;
        this.name = name;
    ...
    public void turnFront() {
        this.setIcon(new ImageIcon("src/images/greenproperty.png"));
